<div class="btm-nav z-50 h-16 md:hidden">
    ...
    <button class="{{ request()->is('notifications') ? 'active' : '' }}">
        <div class="lg:tooltip lg:tooltip-bottom " data-tip="Notifications">
            <a href="{{ route('notifications.index') }}" class="btn btn-circle btn-outline border-none hover:bg-base-200">
                <svg class="{{ request()->is('notifications') ? 'fill-base-content stroke-base-content' : 'stroke-gray-400 fill-gray-400' }}"
