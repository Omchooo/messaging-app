<div class="fixed bottom-20 right-0 mr-14" id="scrollButtonContainer">
...
<script>
    ...
    window.addEventListener('scroll', function() {
      let scrollButtonContainer = document.getElementById('scrollButtonContainer');
      let scrollButton = document.getElementById('scrollButton');
      let scrollPosition = window.scrollY;
      const viewWidth = window.innerWidth;

      if (scrollPosition > 300 && viewWidth >= 640) {
