...
<body class="h-fit pb-16"> {{--  bg-gradient-to-br from-cyan-400 to-sky-900 --}}
    <div class="h-fit flex flex-col justify-center px-2">

            {{-- content --}}
            @yield('content')

            <footer class="fixed bottom-0 w-full justify-between items-center p-4 flex z-30">
