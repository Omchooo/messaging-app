...
@section('content')
    <div class="container mx-auto max-w-4xl md:my-9 flex items-center justify-around">
        <div class="card flex-row w-full justify-center bg-base-100 shadow-lg rounded my-4">
            ...
            <div class="flex flex-col items-center py-20 px-8 w-full relative gap-5">
                ...
                <span class="flex flex-col items-center w-full my-2">
                    <p class="text-lg font-semibold">Don't miss out on the fun</p>
                    <p class="text-sm">Create your InstaByte account now!</p>
                </span>
                ...
                <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" class="w-full max-w-xs">
                    @csrf
                    ...
                    <div class="flex flex-col mx-3 items-center">
                        <div class="form-control w-full max-w-xs mt-3">
                            ...
                            <input type="text" name="username" value="{{ old('username') }}"
                                class="input-sm border-b-base-content focus:ring-info @error('username') focus:ring-error border-b-error @enderror focus:border-none border-x-0 border-t-0 rounded-none w-full max-w-xs bg-base-100"
                        ...
                        <div class="form-control w-full max-w-xs mt-3">
                            ...
                            <input type="text" name="full_name" value="{{ old('full_name') }}"
                                class="input-sm border-b-base-content focus:ring-info @error('full_name') focus:ring-error border-b-error @enderror focus:border-none border-x-0 border-t-0 rounded-none w-full max-w-xs bg-base-100"
                        ...
                        <div class="form-control w-full max-w-xs mt-3">
                            ...
                            <input type="text" name="email" value="{{ old('email') }}"
                                class="input-sm border-b-base-content focus:ring-info @error('email') focus:ring-error border-b-error @enderror focus:border-none border-x-0 border-t-0 rounded-none w-full max-w-xs bg-base-100"
                        ...
                        <div class="form-control w-full max-w-xs mt-3">
                            ...
                            <input type="password" name="password"
                                class="input-sm border-b-base-content focus:ring-info @error('password') focus:ring-error border-b-error @enderror focus:border-none border-x-0 border-t-0 rounded-none w-full max-w-xs bg-base-100"
                                required />
                            @error('password')
                                <span class="label-text text-error mt-2">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-control w-full max-w-xs mt-3">
                            ...
                            <input type="password" name="password_confirmation"
                                class="input-sm border-b-base-content focus:ring-info @error('password_confirmation') focus:ring-error border-b-error @enderror focus:border-none border-x-0 border-t-0 rounded-none w-full max-w-xs bg-base-100"
                                required />
                    ...
                    {{-- <div class="divider my-0"></div> --}}
                    <div class="mx-9 mt-8">
                        <button type="submit" class="btn btn-sm btn-info h-9 w-full dark:text-white">Sign up</button>
                    </div>
                </form>

                <span class="flex gap-2 justify-center w-full my-2 text-sm">
                    Already have an account? <a href="{{ route('login') }}" class="font-semibold text-info">Sign in</a>
                </span>
            </div>
